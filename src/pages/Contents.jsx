        ...
        >
            <div className="text-center mb-16">
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                >
                    Libros de apoyo para tu preparación
                </motion.p>
            </div>
                ...
                {[
                    {
                        ...
                        author: "Kendall, K. E. y E. Kendall, J. (8va. ed., 2005)",
                        cover: "https://m.media-amazon.com/images/I/51Y8TR5ZfBL._SY425_.jpg",
                        url: "https://ccie.com.mx/wp-content/uploads/2020/03/ld-Analisis-y-Diseno-de-Sistemas_Kendall-8va.pdf",
                        color: "bg-blue-100"
                    },
                    {
                        title: "Sistemas de información gerencial",
                        author: "Laudon, K. (12va. ed., 2012)",
                        cover: "https://m.media-amazon.com/images/I/51Nq7D9AB4L._SY425_.jpg",
                        url: "https://juanantonioleonlopez.files.wordpress.com/2017/08/sistemas-de-informacic3b3n-gerencial-12va-edicic3b3n-kenneth-c-laudon.pdf",
                        color: "bg-green-100"
                    },
                    {
                        title: "PMBOK GUIDE",
                        author: "Project Management Institute (5ta. ed.)",
                        cover: "https://m.media-amazon.com/images/I/51QxQ0WKL9L._SY425_.jpg",
                        url: "https://topodata.com/wp-content/uploads/2019/10/PMBOK_Guide5th_Spanish.pdfJOFO.pdf",
                        color: "bg-purple-100"
                    },
                    {
                        title: "Ingeniería del software. Un enfoque práctico",
                        author: "Pressman, R. (7ma. ed., 2010)",
                        cover: "https://m.media-amazon.com/images/I/51Y5Z8ZQZ9L._SY425_.jpg",
                        url: "https://www.javier8a.com/itc/bd1/ld-Ingenieria.de.software.enfoque.practico.7ed.Pressman.PDF",
                        color: "bg-yellow-100"
                    },
                    {
                        title: "Ingeniería de software",
                        author: "Sommerville, I. (9a. ed., 2011)",
                        cover: "https://m.media-amazon.com/images/I/51Y5Z8ZQZ9L._SY425_.jpg",
                        url: "https://www.academia.edu/25063155/Ingenieria_de_Software_Somerville",
                        color: "bg-red-100"
                    }
                ].map((book, index) => (
                    <motion.div
                        key={index}
                        className={`${book.color} rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300`}
                    ...
                    >
                        <div className="p-6">
                            <div className="flex items-center mb-4">
                                <div className="w-16 h-16 rounded-lg overflow-hidden shadow-md mr-4">
                                    <img 
                                        src={book.cover} 
                            ...
                            <motion.a
                                ...
                                className="inline-block w-full py-2 px-4 bg-white text-center rounded-lg font-medium hover:bg-gray-50 transition-colors"
            ...
            <motion.div 
                ...
                viewport={{ once: true }}
            >
                <p className="text-gray-500 mb-4">¿Conoces otro libro que pueda ser útil?</p>
                <motion.button
                    className="px-6 py-2 border-2 border-blue-500 text-blue-500 rounded-full font-medium hover:bg-blue-50 transition-colors"
